...
void D3D12nBodyGravity::OnUpdate()
{
	...
	XMStoreFloat4x4(&constantBufferGS.worldViewProjection, XMMatrixMultiply(m_camera.GetViewMatrix(), m_camera.GetProjectionMatrix(2.61799f, m_aspectRatio, 1.0f, 5000.0f)));
